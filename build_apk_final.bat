@echo off
echo ========================================
echo    GENERATION APK FINAL SANOC PATIENT
echo ========================================
echo.
...
copy "build\app\outputs\flutter-apk\app-release.apk" "release\APK\sanoc_patient_v1.0.apk"
echo.
...
echo ========================================
echo.
echo Fichier APK : release\APK\sanoc_patient_v1.0.apk
echo.
